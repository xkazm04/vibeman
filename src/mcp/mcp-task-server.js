...
// Configuration file for Cursor (.cursor/mcp.json)
const cursorConfig = {
  "mcpServers": {
    "task-executor": {
      "command": "node",
      "args": [path.join(__dirname, "mcp-task-server.js")],
      "env": {
...
fs.writeFile('.cursor/mcp.json', JSON.stringify(cursorConfig, null, 2))
  .catch(console.error);