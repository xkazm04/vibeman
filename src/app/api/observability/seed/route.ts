...
const SAMPLE_ENDPOINTS = [
  ...
  { endpoint: '/api/scan-queue/worker', method: 'GET' as const, avgTime: 15, errorRate: 0.01, callsPerDay: 50 },
  { endpoint: '/api/scan-queue/worker/start', method: 'POST' as const, avgTime: 5000, errorRate: 0.15, callsPerDay: 15 },
  { endpoint: '/api/scan-queue/worker/stop', method: 'DELETE' as const, avgTime: 100, errorRate: 0.05, callsPerDay: 10 },
  { endpoint: '/api/scan-queue/worker/config', method: 'PATCH' as const, avgTime: 50, errorRate: 0.02, callsPerDay: 5 },
