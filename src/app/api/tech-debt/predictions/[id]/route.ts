/**
 * Individual Debt Prediction API (Consolidated)
...
export async function GET(
  ...
  try {
    ...
    logger.error('[TechDebt Prediction API] GET error:', { data: error });
    return NextResponse.json(
...
export async function PATCH(
  ...
  try {
    ...
    logger.error('[TechDebt Prediction API] PATCH error:', { data: error });
    return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    logger.error('[TechDebt Prediction API] DELETE error:', { data: error });
    return NextResponse.json(
