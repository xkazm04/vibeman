 ...
 */
export const GET = withRemoteSupabase('Remote/Commands', async (supabase, request: NextRequest) => {
 ...
 * POST: Submit a new command
 */
export const POST = withRemoteSupabase('Remote/Commands', async (supabase, request: NextRequest) => {
