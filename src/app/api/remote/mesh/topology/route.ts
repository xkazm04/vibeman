 ...
 */
export const GET = withRemoteSupabase('Mesh/Topology', async (supabase, request: NextRequest): Promise<NextResponse<TopologyResponse>> => {
 ...
 */
export const POST = withRemoteSupabase('Mesh/Topology', async (supabase, request: NextRequest) => {
