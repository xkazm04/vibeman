...
/**
 * Create all core database tables (IF NOT EXISTS).
 * Separated from index/migration logic for independent testability.
 */
export function createCoreTables(db: DbConnection) {
  // Create goals table
  db.exec(`
