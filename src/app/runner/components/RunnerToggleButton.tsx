...
const RunnerToggleButton = React.memo(({ isExpanded, onToggle }: RunnerToggleButtonProps) => {
  return (
    <motion.button
      onClick={onToggle}
...
RunnerToggleButton.displayName = 'RunnerToggleButton';

export default RunnerToggleButton;