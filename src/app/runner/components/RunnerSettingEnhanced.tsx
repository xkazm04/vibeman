...
interface RunnerSettingEnhancedProps {
  project: Project;
...
export const RunnerSettingEnhanced: React.FC<RunnerSettingEnhancedProps> = React.memo(({
  project,
  projectData,
  projectHasChanges,
  isExpanded,
...
RunnerSettingEnhanced.displayName = 'RunnerSettingEnhanced'; 