...
export function ZenCommandCenter() {
  return (
    <div className={`h-screen flex flex-col ${zen.bgGradient}`}>
      {/* Status Bar */}
      <ZenStatusBar />
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Event Sidebar */}
        <div className={`w-80 border-l ${zen.surfaceDivider} flex flex-col bg-gray-900/30 shrink-0`}>
          <ZenEventSidebar />
        </div>
      </div>

      {/* Footer */}
      <div className={`px-6 py-3 border-t ${zen.surfaceDivider} flex items-center justify-center shrink-0`}>
