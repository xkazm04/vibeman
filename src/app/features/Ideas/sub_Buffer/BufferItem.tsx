    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-1 flex-shrink-0">
          ...
          {idea.provider && (
            <span
              className="text-[9px] px-1 py-0.5 rounded bg-gray-700/60 text-gray-500 font-medium uppercase leading-none"
          ...
          {idea.detailed === 1 && (
            <span
              className="text-[9px] px-1 py-0.5 rounded bg-amber-500/20 text-amber-400 font-medium leading-none"
