...
export function ComponentTable({ categoryId, onComponentClick }: ComponentTableProps) {
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-gray-800/50 bg-gray-900/30">
      {/* Table Header */}
      <div className="grid grid-cols-[1fr_2fr_auto_auto] gap-4 px-4 py-2.5 bg-gray-800/40 border-b border-gray-800/50 text-xs font-medium text-gray-500 uppercase tracking-wider">
        <div>Name</div>
        <div>Description</div>
      ...
      <AnimatePresence mode="popLayout">
        {sortedComponents.map((component, index) => (
          <motion.button
            ...
            className={`
              w-full grid grid-cols-[1fr_2fr_auto_auto] gap-4 px-4 py-3
