...
function PerformanceTierBadge({ tier }: { tier: TierKey }) {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-2xs font-semibold border ${cfg.bg} ${cfg.color} ${cfg.border}`}
    >
      ...
      <div className="border-t border-gray-700/30 p-3 mt-1 space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <span
              className={`text-2xs flex items-center gap-1 ${TREND_COLORS[ranking.trend]}`}
            >
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="rounded-lg bg-gray-800/60 border border-gray-700/40 p-2 text-center">
            ...
            <p className="text-micro text-gray-500 mt-0.5">Accept Rate</p>
          </div>
          <div className="rounded-lg bg-gray-800/60 border border-gray-700/40 p-2 text-center">
            <p className="text-sm font-bold text-purple-400">
              <AnimatedNumber value={ranking.totalIdeas} />
            </p>
            <p className="text-micro text-gray-500 mt-0.5">Total Ideas</p>
          </div>
          <div className="rounded-lg bg-gray-800/60 border border-gray-700/40 p-2 text-center">
            <p className="text-sm font-bold text-emerald-400">
              <AnimatedNumber value={scorePct} />
            </p>
            <p className="text-micro text-gray-500 mt-0.5">Score</p>
          </div>
        </div>
        ...
        {/* Recommendation */}
        <p className="text-2xs text-gray-400 leading-relaxed italic">
  ...
  return (
    ...
    >
      <div className="border-t border-gray-700/30 p-3 mt-1">
        <div className="text-2xs text-gray-500 uppercase tracking-wider mb-2 text-center">
          Comparison
        </div>
        ...
        <div className="grid grid-cols-[1fr_auto_1fr] gap-2 mb-2">
          ...
          <div className="flex items-center text-gray-600 text-2xs font-mono">
            vs
          </div>
          <div className="text-center">
            <span className="text-xs font-semibold text-white">
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center">
                <span className="text-micro text-gray-600">{m.label}</span>
                {delta !== 0 && (
                  <span
          ...
          {rankings.map((r) => {
            ...
            return (
              <button
                ...
                className={`flex flex-col gap-1 px-2 py-1.5 rounded text-left transition-all text-2xs ${
                  isSelected
