 ...
 *
 * These types power the statistical/rule-based insight system (KPIs, rankings,
 * scan recommendations) derived from Ideas data. This is distinct from the
 * AI-based insight system (ExecutiveAIInsight in reflector.types.ts) which
 * uses Claude Code for deep analysis and stores results in the DB.
 *
 * Both systems coexist in ExecutiveSummary.tsx as separate tabs.
 */
