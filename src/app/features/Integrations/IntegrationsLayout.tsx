...
function EmptyProjectState() {
  return (
    <div className="flex flex-col items-center justify-center h-96 text-center">
      <div className="w-16 h-16 rounded-full bg-gray-800/50 flex items-center justify-center mb-4 shadow-lg shadow-purple-500/5">
        <Plug className="w-8 h-8 text-gray-500" />
      </div>
      <h3 className="text-lg font-medium text-gray-300 mb-2 tracking-tight">No Project Selected</h3>
              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`relative px-4 py-2 rounded-md text-sm flex items-center gap-2 transition-all duration-200 ${
                      activeTab === tab.id
