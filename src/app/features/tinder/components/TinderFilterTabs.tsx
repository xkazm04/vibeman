        ...
        return (
          <motion.button
            ...
            className={`
              ...
              focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 focus-visible:ring-cyan-400
        ...
        <>
          ...
          <motion.button
            ...
            className={`
              ...
              transition-all duration-300 ease-out
              focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 focus-visible:ring-emerald-400
              ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}
              ${isRemoteMode
