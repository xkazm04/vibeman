    ...
    <div className="flex items-center justify-center gap-4 pt-4">
      ...
      <motion.button
        ...
        className={`flex items-center justify-center w-12 h-12 rounded-full transition-all duration-300 ease-out ${
          disabled
            ...
            : 'bg-red-500/20 hover:bg-red-500/30 border-2 border-red-500 text-red-400 shadow-lg shadow-red-500/20 hover:shadow-xl hover:shadow-red-500/30 hover:border-red-400 active:scale-95'
        }`}
      ...
      <motion.button
        ...
        className={`flex items-center justify-center w-12 h-12 rounded-full transition-all duration-300 ease-out ${
          disabled
            ? 'bg-gray-700 text-gray-500 cursor-not-allowed opacity-60'
            : 'bg-green-500/20 hover:bg-green-500/30 border-2 border-green-500 text-green-400 shadow-lg shadow-green-500/20 hover:shadow-xl hover:shadow-green-500/30 hover:border-green-400 active:scale-95'
        }`}
