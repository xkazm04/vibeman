      ...
      <div className="p-4 border-b border-gray-700/30">
        <div className="relative">
          ...
          <input
            ...
            className={`w-full pl-10 pr-4 ${inputStyle} hover:bg-gray-800/70`}
          />
        </div>
      ...
      <div className="px-4 py-3 border-b border-gray-700/30 flex items-center justify-between">
        ...
        {selectedPaths.length === 1 && projectPath && (
          <button
            ...
            className={`flex items-center gap-1.5 ${buttonVariants.ghost} text-sm disabled:opacity-50 disabled:cursor-not-allowed`}
          >
            {isAnalyzing ? (
              <>
