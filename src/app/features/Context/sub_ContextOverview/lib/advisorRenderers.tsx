...
export const SummaryBox: React.FC<{ text: string }> = ({ text }) => (
...
export const RecommendationItem: React.FC<{ rec: AdvisorRecommendation; index: number }> = ({ rec, index }) => (
...
export const VulnerabilityItem: React.FC<{ vuln: AdvisorVulnerability; index: number }> = ({ vuln, index }) => (
  <AnimatedCard index={index}>
    <div className="flex items-start justify-between mb-2">
...
export const ImprovementItem: React.FC<{ imp: AdvisorImprovement; index: number }> = ({ imp, index }) => (
  <AnimatedCard index={index}>
    <div className="flex items-start justify-between mb-2">
...
export const renderUXResponse = (data: UXResponseData, color: string) => (
  <motion.div
    initial={{ opacity: 0, y: 10 }}
    animate={{ opacity: 1, y: 0 }}
    exit={{ opacity: 0, y: -10 }}
...
export const renderSecurityResponse = (data: SecurityResponseData, color: string) => (
  <motion.div
    initial={{ opacity: 0, y: 10 }}
    animate={{ opacity: 1, y: 0 }}
    exit={{ opacity: 0, y: -10 }}
...
export const renderArchitectResponse = (data: ArchitectResponseData, color: string) => (
  <motion.div
    initial={{ opacity: 0, y: 10 }}
    animate={{ opacity: 1, y: 0 }}
    exit={{ opacity: 0, y: -10 }}
...
export const renderVisionaryResponse = (data: VisionaryResponseData, color: string) => (
  <motion.div
    initial={{ opacity: 0, y: 10 }}
    animate={{ opacity: 1, y: 0 }}
    exit={{ opacity: 0, y: -10 }}
...
export const renderChumResponse = (data: ChumResponseData, color: string) => (
  <motion.div
    initial={{ opacity: 0, y: 10 }}
    animate={{ opacity: 1, y: 0 }}
    exit={{ opacity: 0, y: -10 }}
...
export const renderMarkdownFallback = (markdown: string, color: string) => (
  <motion.div
    initial={{ opacity: 0, y: 10 }}
    animate={{ opacity: 1, y: 0 }}
    exit={{ opacity: 0, y: -10 }}
...
export const renderGenericResponse = (data: GenericResponseData, advisor: AdvisorPersona) => {
