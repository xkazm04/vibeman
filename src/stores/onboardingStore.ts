...
export type AppModule = 'overview' | 'coder' | 'contexts' | 'ideas' | 'tinder' | 'tasker' | 'reflector' | 'manager' | 'halloffame' | 'social' | 'zen' | 'blueprint' | 'questions' | 'integrations' | 'brain' | 'commander' | 'conductor' | 'views';
