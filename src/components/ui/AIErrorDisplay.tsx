...
// Compact error view component
function CompactErrorView({
  errorDetails,
  onRetry,
  onDismiss,
}: {
    ...
    >
      ...
      {onDismiss && (
        <button
          ...
          data-testid="compact-dismiss-btn"
        >
...
function SuggestedActions({ suggestions }: { suggestions: string[] }) {
...
export default function AIErrorDisplay({
  ...
  return (
    ...
    >
      <ErrorHeader errorDetails={errorDetails} onDismiss={onDismiss} />
      ...
      <SuggestedActions suggestions={errorDetails.suggestions} />
      ...
      <div className="flex items-center gap-3">
        <motion.button
          ...
          data-testid="retry-operation-btn"
        >
