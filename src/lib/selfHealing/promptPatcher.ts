 ...
 *
 * NOTE: persists to the `conductor_healing_patches` table, which is retained
 * (orphaned) after the Conductor module removal so this self-healing path keeps
 * working for the Claude Code execution queue.
 */
