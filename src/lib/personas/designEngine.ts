...
export function buildDesignPrompt(
  ...
  "suggested_event_subscriptions": [
    {
      "event_type": "webhook_received|execution_completed|persona_action|credential_event|task_created|custom",
      "source_filter": { "source_type": "webhook" },
      "description": "Why this persona subscribes to this event"
    }
  ],
  "feasibility": {
...
function buildRefinementPrompt(
  ...
  parts.push('{ "structured_prompt": {...}, "suggested_tools": [...], "suggested_triggers": [...], "full_prompt_markdown": "...", "summary": "...", "design_highlights": [...], "suggested_connectors": [...], "suggested_notification_channels": [...], "suggested_event_subscriptions": [...], "feasibility": { "confirmed_capabilities": [...], "issues": [...], "overall_feasibility": "ready|partial|blocked" } }');
  parts.push('');
